...
/**
 * Class BLASTN implements nucleotide alignments. It provides the scoring and
 * word generation functions used in nucleotide sequence alignments
 * @author Sean McGroty
 */
public class BLASTN extends BLAST {
     ...
     * @param lambda
     */
    public BLASTN(int wordLength, int scoreCutoff, int match, int mismatch,
                  double eCut, int dbLength, double K, double lambda) {
