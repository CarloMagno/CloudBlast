...
public class ProteinSequence extends Sequence {
     ...
     *     <TT>'-'</TT>.
     */
    public ProteinSequence(String description, String sequence) {
        ...
        for (int i = 0; i < myLength; ++i) {
            ...
            if ('A' <= b && b <= 'Z') {
                ...
                throw new IllegalArgumentException("ProteinSequence(): Invalid amino acid '" +
                                                   b + "'");
            }
        }
    }
     ...
     *     Thrown if an I/O error occurred.
     */
    public ProteinSequence(InputStream in) throws IOException {
        read(in);
    }
    ...
    private void read(InputStream in) throws IOException {
        ...
        for (; ; ) {
            ...
            if (b == -1 || b == '>') {
                ...
                throw new IOException("ProteinSequence(): Invalid amino acid '" +
                                      ((char)b) + "'");
            }
        }
    ...
    public char charAt(int i) {
        if (1 > i || i > myLength) {
            throw new IndexOutOfBoundsException("ProteinSequence.charAt(): Index " +
                                                i + " out of bounds");
        }
        int aa = mySequence[i];
        if (0 <= aa && aa <= 25)
