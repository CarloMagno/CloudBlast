 ...
 * align() method of class ProteinLocalAlignment.
 * 
 ...
 * example, the ID could be the index of a sequence in a ProteinDatabase.
 * 
 ...
 * @version 03-Jul-2008
 */
public class Alignment implements Externalizable {
    ...
    public int compareTo(Alignment alignment) {
        if (this.myScore > alignment.myScore)
            return -1;
        else if (this.myScore < alignment.myScore)
            return 1;
        else if (this.mySubjectId < alignment.mySubjectId)
            return -1;
        else if (this.mySubjectId > alignment.mySubjectId)
            return 1;
        else
    ...
    public boolean equals(Object other) {
        return (this.mySubjectStart == ((Alignment)other).mySubjectStart &&
                this.mySubjectFinish == ((Alignment)other).mySubjectFinish &&
                this.myQueryStart == ((Alignment)other).myQueryStart &&
                this.myQueryFinish == ((Alignment)other).myQueryFinish);
    }
    ...
    public int hashCode() {
        ...
        int hash =
            this.myScore << 16 | this.myQueryStart << 8 | this.myQueryFinish <<
            4 | this.mySubjectStart << 2 | this.mySubjectFinish << 1;
